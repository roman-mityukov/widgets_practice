...
// Делегирует работу с потомками своему FlowDelegate. Flow layouts are
// optimized for repositioning children using transformation matrices.
// Не путать с flow layout в андроид например, во Flutter это Wrap
...
class _FlowMenuState extends State<FlowPractice>
